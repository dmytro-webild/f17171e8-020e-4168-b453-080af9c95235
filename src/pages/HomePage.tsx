  ...
  <div id="neden-biz" data-section="neden-biz">
    <SectionErrorBoundary name="neden-biz">
      ...
      items={[
        {
          title: "Kaliteli Ürün",
          description: "Standartlara uygun, en yüksek kaliteli malzemeler.",
        ...
        {
          title: "Uygun Fiyat",
          description: "Rekabetçi fiyat politikasıyla bütçe dostu.",
          imageSrc: "http://img.b2bpic.net/free-photo/people-taking-care-warehouse-logistics-together_23-2149128297.jpg",
        },
        {
          title: "Deneyimli Ekip",
          description: "Profesyonel kadromuzla teknik destek.",
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-people-working-construction_23-2150772880.jpg",
        },
      ]}
      textAnimation="slide-up"
    />
  ...
  <div id="hizmetler" data-section="hizmetler">
    <SectionErrorBoundary name="hizmetler">
      ...
      items={[
        {
          icon: Truck,
          title: "Çimento Satışı",
          description: "Her türlü çimento ihtiyacınız için hızlı tedarik.",
        },
        {
          icon: Wrench,
          title: "İnşaat Malzemeleri",
          description: "Geniş ürün yelpazemizle eksiksiz çözüm.",
        },
        {
          icon: Building2,
          title: "Şantiye Tedariki",
          description: "Şantiyenize yerinde ve zamanında teslimat.",
        },
        {
          icon: Package,
          title: "Toplu Sipariş",
          description: "Büyük ölçekli projeler için özel fiyat teklifleri.",
        },
      ]}
  ...
  <div id="urunler" data-section="urunler">
    <SectionErrorBoundary name="urunler">
      ...
      items={[
        {
          title: "İnşaat Demiri",
          description: "Dayanıklı ve sertifikalı.",
          imageSrc: "http://img.b2bpic.net/free-photo/triple-x-architecture-design-building_122409-15.jpg",
        },
        {
          title: "Çimento",
          description: "Endüstriyel standartlarda.",
          imageSrc: "http://img.b2bpic.net/free-photo/worker-builds-cinder-block-wall-new-home_661209-381.jpg",
        },
        {
          title: "Beyaz Çimento",
          description: "Dekoratif ve sağlam.",
          imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-clay-smudge_23-2148862878.jpg",
        },
        {
          title: "Gazbeton",
          description: "Enerji tasarruflu.",
          imageSrc: "http://img.b2bpic.net/free-photo/old-rusty-metallic-surface-close-up_23-2148846146.jpg",
        },
        {
          title: "Kireç",
          description: "Harçlarınız için ideal.",
          imageSrc: "http://img.b2bpic.net/free-photo/unfinished-brick-building-site_23-2147694730.jpg",
        },
        {
          title: "Tuğla",
          description: "Yüksek mukavemetli.",
          imageSrc: "http://img.b2bpic.net/free-photo/photo-wall-texture-pattern_58702-12640.jpg",
        },
        {
          title: "Kum & Mıcır",
          description: "Doğal ve kaliteli.",
          imageSrc: "http://img.b2bpic.net/free-photo/grained-stone-surface_23-2147626094.jpg",
        },
      ]}
      textAnimation="slide-up"
    />
      ...
      items={[
        {
          ...
          description: "İhtiyaçlarınızı uzman ekibimize iletin.",
          imageSrc: "http://img.b2bpic.net/free-photo/colleagues-smiling-speaking-holding-tablet-notebook-office_176420-935.jpg",
        },
        {
          title: "Teklif Hazırlıyoruz",
          description: "En uygun fiyat seçenekleriyle.",
          imageSrc: "http://img.b2bpic.net/free-photo/business-owner-working-their-strategy_23-2149241314.jpg",
        },
        {
          title: "Ürünleri Hazırlıyoruz",
          description: "Kalite kontrol süreçlerimizle.",
          imageSrc: "http://img.b2bpic.net/free-photo/happy-employee-dancing-warehouse_482257-81048.jpg",
        },
        {
          title: "Hızlı Teslim Ediyoruz",
          description: "Sahada hızlı ve güvenli teslimat.",
          imageSrc: "http://img.b2bpic.net/free-photo/transport-logistics-concept_23-2151541898.jpg",
        },
      ]}
      textAnimation="slide-up"
    />
      ...
      testimonials={[
        {
          name: "Ahmet Yılmaz",
          role: "Müteahhit",
          quote: "Yıllardır Selçuk Ticaret ile çalışıyoruz, çok profesyoneller.",
        ...
        },
        {
          name: "Ayşe Kaya",
          role: "Mimari Tasarım",
          quote: "İhtiyaçlarımıza tam zamanında cevap veriyorlar, teşekkürler.",
          imageSrc: "http://img.b2bpic.net/free-photo/architect-her-working-desk-with-blueprints-front-her-working-new-projects-architecture-design_482257-33166.jpg",
        },
        {
          name: "Mehmet Demir",
          role: "Şantiye Şefi",
          quote: "Malzeme kaliteleri ve hızları tartışılmaz, mükemmel.",
        ...
        },
        {
          ...
          quote: "Projemizin en büyük destekçisi, çözüm ortağımızdır.",
          imageSrc: "http://img.b2bpic.net/free-photo/female-engineer-helmet-gear-holding-construction-plan-pointing-it_114579-24439.jpg",
        },
        {
          name: "Canan Çelik",
          role: "Firma Sahibi",
          quote: "Güler yüzlü ve uzman ekiple çalışmak çok keyifli.",
